...
class _TypeWriterTextState extends State<TypeWriterText> with SingleTickerProviderStateMixin {
  ...
  Future<void> _run(BuildContext context) async {
    if (_tick < (widget._type == _TypeWriterTextType._text ? widget.text!.data!.length : widget.data.length)) {
  ...
  Widget build(BuildContext context) {
    switch (widget._type) {
      case _TypeWriterTextType._builder:
        return widget.builder!(context, widget.play ? widget.data.substring(0, _tick) : widget.data);
      case _TypeWriterTextType._text:
        if (!widget.play) {
          ...
          return LayoutBuilder(
            builder: (_, constraints) {
              ...
              TextPainter textPainter = TextPainter(
                  ...
                  text: TextSpan(
                      text: text.data!, style: text.style, locale: text.locale, semanticsLabel: text.semanticsLabel),
